...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-17 17:45`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5016b746-3a0c-4538-a8ee-a048916ce6d9.git
$ cd 5016b746-3a0c-4538-a8ee-a048916ce6d9
```
